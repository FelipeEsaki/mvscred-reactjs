...
const servicosItens = [
    ...
    },
    {
        ...
        servico: 'Seguros',
        texto: `A ${ItensToChange.brandname} possui <strong>todos os tipos de seguros</strong> e <strong>mais de 10 seguradoras</strong> parceiras para melhor atender sua necessidade!`
    },
    {
        imagem: `assets/servicos/consorcio.jpg`,
        servico: 'Consórcios',
        texto: `A ${ItensToChange.brandname} oferece a <strong>melhor opção de consórcio</strong> de acordo com sua necessidade. Trabalhamos com todos os tipos de consórcios!`
    },
    {
    ...
    },
    {
        ...
        texto: `Está na hora de adquirir seu <strong>novo veículo</strong>! Com a ${ItensToChange.brandname} você tem as <strong>melhores taxas</strong> e opções de financiamento!`
    },
    {
        imagem: `assets/servicos/casa.jpg`,
        servico: 'Financiamento Residencial',
        texto: `Está na hora de adquirir sua <strong>nova casa</strong>! Com a ${ItensToChange.brandname} você tem as <strong>melhores taxas</strong> e opções de financiamento, refinanciamento e carta fiança!`
    },
    {
        imagem: `assets/servicos/conta.jpg`,
        servico: 'Abertura de conta',
        texto: `Abra sua conta bancária <strong>sem custo</strong>! Com a ${ItensToChange.brandname} você tem os <strong>melhores bancos</strong> para abrir sua conta bancária digital!`
    },
    {
    ...
    },
    {
        ...
        texto: `A ${ItensToChange.brandname} oferece opções de <strong>crédito através da maquininha de cartão</strong>, <strong>ideal para negativados</strong>! `
    },
];
